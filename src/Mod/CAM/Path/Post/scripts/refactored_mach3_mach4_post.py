...
FormatHelp = str
GCodeSections = List[Tuple[str, str]]
Parser = argparse.ArgumentParser
ParserArgs = Union[str, argparse.Namespace]
...
M2"""
    ...
    def process_arguments(self) -> Tuple[bool, ParserArgs]:
        ...
        #
        # If the flag is False, then all that is returned is a string
        # containing the argument list formatted for output
        #
