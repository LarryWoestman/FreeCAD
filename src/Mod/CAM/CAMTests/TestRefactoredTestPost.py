...
""",
    ...
    def test00138(self) -> None:
        ...
        output_file_pattern = "test_postprocessor_write.nc"
...
"""
        ...
        gcode = self.post.export()[0][1]
        self.assertEqual(gcode, expected)
        # also test what is written to a file
        CommandPathPost._write_file(self, fname, gcode, policy)
        with open(fname, "rb") as fp:
            written_gcode = fp.read()
        remove(fname)
        expected = expected.replace("\n", linesep)
        self.assertEqual(expected.encode("utf-8"), written_gcode)
        ...
        expected = "G90\rG21\rG54\rM6 T1\r"
